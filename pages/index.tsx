...
export default function Home() {
  ...
  const meta = {
    title: "Harsh Dhaduk - Full Stack Developer",
    description: `Harsh Dhaduk - Full Stack Developer passionate about crafting dynamic and responsive web applications. Explore my coding adventures!`,
    image: "/img/logo2.jpg",
    type: "website",
  };
  ...
  return (
    <>
      ...
      <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
        {!context.sharedState.finishedLoading && ShowThisCantBeReached && (
          <ThisCantBeReached />
        )}
        ...
        {context.sharedState.finishedLoading && (
          <Footer
            githubUrl={"https://github.com/HarshDhaduk2001"}
