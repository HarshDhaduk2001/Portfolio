...
const CompaniesBar = (props: any) => {
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[80px] translate-y-1 md:w-0.5  
      ...
      >
        ...
        <motion.div
          ...
          // ref={barRef}
          className={`absolute w-10 h-0.5 md:w-0.5 md:h-[48px] rounded bg-AAsecondary `}
        ></motion.div>
      </div>
